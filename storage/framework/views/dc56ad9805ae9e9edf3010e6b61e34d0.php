                    ...
                    <tr class="align-middle border-bottom">
                        ...
                        <td style="text-align: center;">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="<?php echo e(route('admin.detail_aduan', $row->id_aduan)); ?>" class="btn btn-link text-muted p-0 text-decoration-none">
...
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fasiliticare-ta\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>