...
<div class="container my-4">
    <div class="mb-3">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-outline-secondary btn-sm rounded-pill px-3">
    ...
    <div class="row mt-5">
        <div class="col-md-6 mb-4">
            ...
            <h5 class="fw-bold text-dark"><?php echo e($aduan->anggota->nama_lengkap); ?></h5>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fasiliticare-ta\resources\views/admin/detail_aduan.blade.php ENDPATH**/ ?>